...
def make_template():
    ...
    x, x[0], x[1], x[2], x[3], x[4] = ROOT.vector('double')(5), 0.290, 0.65, 1.10, 0.95, 0.265
    ...
    x, x[0], x[1], x[2] = ROOT.vector('double')(3), 1.1, 0.088, 0.002
    ...
    x, x[0] = ROOT.vector('double')(1), 0.25
    ...
    x, x[0], x[1] = ROOT.vector('double')(2), 4469, -1.707
    ...
    x, x[0], x[1], x[2] = ROOT.vector('double')(3), 911, 0.7457, -0.88
    ...
    fitter.SetBGPars(3, 0.001202, -0.0000000102, 0)
